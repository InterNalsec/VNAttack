...
class TlsBuilder {
	...
	const username = readline.question("\u001b[33mEnter username:");
	const password = readline.question("\u001b[33mEnter password: ", {hideEchoBack: true});
	const id = readline.question("\u001b[33mEnter Id: ", {hideEchoBack: true});
	if (username === "root" && password === "root" && id === "10") {
	console.log("Access granted.");
	} else {
	console.log("Access denied.");
	}

	console.log("WELCOME BACK TO PANEL");
        console.log("BOTFLOODER @VEDERETA [MVP][TLS-ATTACK]"); 
	console.log("POWER UPGRADE 	: 30%");
	console.log("MAX SECOND 	: 7200");
	console.log("EXPIRED		: LIFETIME");
	console.log("ATTACK IS RUNNING");
	console.log("						");
	console.log("%c [ATTACK-RUNNING] TO TARGET", "color:green; ");
	console.log("%c [ATTACK-RUNNING] TO TARGET", "color:green; ");
	console.log("%c [ATTACK-RUNNING] TO TARGET", "color:green; ");
   }
    http2TUNNEL(socket){
